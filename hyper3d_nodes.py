    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                "api_key": ("APIKEY", {"forceInput": True, "multiline": True}),
                "images": ("IMAGE", {"forceInput": True, "multiline": True}),
                "tier": (["Gen-2.5-Minimum", "Gen-2.5-Extreme-Low", "Gen-2.5-Low", "Gen-2.5-Medium", "Gen-2.5-High"], {"default":"Gen-2.5-Medium"}),
                "seed_": ("INT", {"default": 0, "min": 0, "max": 65535, "step": 1, "display": "number", }),
                "Material_Type": (["PBR", "Shaded", "All", "None"], {"default":"PBR"}),
                "geometry_file_format": (["glb", "usdz"], {"default":"glb"}),
                "mesh_faces": ("INT", {"default": 20000, "min": 1000, "max": 20000, "step": 1, "display": "number", }),
                "texture_mode": (["minimum", "extreme-low", "low", "medium", "high", "Default"], {"default":"Default"}),
                "TAPose": ("BOOLEAN", {"default": False}),
            },
            "optional":{
                "bbox": ("STRING",{"forceInput":True,"multiline": True}),
    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                "api_key": ("APIKEY", {"forceInput": True, "multiline": True}),
                "images": ("IMAGE", {"forceInput": True, "multiline": True}),
                "tier": (["Gen-2.5-Low", "Gen-2.5-Medium", "Gen-2.5-High"], {"default":"Gen-2.5-Medium"}),
                "seed_": ("INT", {"default": 0, "min": 0, "max": 65535, "step": 1, "display": "number", }),
                "Material_Type": (["PBR", "Shaded", "All", "None"], {"default":"PBR"}),
    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "texture_mode": (["legacy", "minimum", "extreme-low", "low", "medium", "high"], {"default":"high"}),
